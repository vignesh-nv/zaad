...
class DailyTaskYoutubePlayer(private val youTubePlayerView: YouTubePlayerView, private val youTubePlayer: YouTubePlayer) : PlayerUiController {

    val rootView: View = View.inflate(youTubePlayerView.context, R.layout.daily_task_youtube_video_player_ui, null)
...
//        }
    ...
    override fun getMenu(): YouTubePlayerMenu? {
        TODO("Not yet implemented")
    }
    ...
    private fun updatePlayPauseButtonIcon(playing: Boolean) {
        val drawable = if (playing) com.pierfrancescosoffritti.androidyoutubeplayer.R.drawable.ayp_ic_pause_36dp else com.pierfrancescosoffritti.androidyoutubeplayer.R.drawable.ayp_ic_play_36dp
